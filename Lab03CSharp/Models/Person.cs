...
namespace Lab03CSharp.Models
{
    ...
    class Person
    {
        ...
        public string Email
        {
            ...
            set {
               ...
               @"(?(\[)(\[(\d{1,3}\.){3}\d{1,3}\])|(([0-9a-z][-\w]*[0-9a-z]*\.)+[a-z0-9]{2,17}))$";
                ...
                {
                    throw new IncorrectEmailException("Email is incorrect", value);
                }
        ...
        public DateTime BirthDate
        {
            ...
            set
            {
                if (DateTime.Today < value) throw new BornInFutureException("Incorrect date, You cant be born in future",value);
                else if (new DateTime(DateTime.Today.Subtract(value).Ticks).Year > 135) throw new IncorrectBirthDateException("Your birth date is > 135",value);
                _birthDate = value;
            }
        }
        public bool IsAdult
